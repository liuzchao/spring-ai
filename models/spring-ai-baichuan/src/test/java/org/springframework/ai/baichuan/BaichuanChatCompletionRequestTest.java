...
public class BaichuanChatCompletionRequestTest {

	BaichuanChatModel chatModel = new BaichuanChatModel(new BaichuanApi(System.getenv("BAICHUAN_API_KEY")));
	...
	void chatCompletionRequestWithOptionsTest() {
		var options = BaichuanChatOptions.builder().withTemperature(0.5).withTopP(0.8).build();
