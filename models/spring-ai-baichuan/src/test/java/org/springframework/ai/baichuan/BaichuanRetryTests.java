...
public class BaichuanRetryTests {

	private TestRetryListener retryListener;

	private @Mock BaichuanApi moonshotApi;

	private BaichuanChatModel chatModel;
	...
	public void beforeEach() {
		...
		this.chatModel = new BaichuanChatModel(this.moonshotApi,
				BaichuanChatOptions.builder()
					.withTemperature(0.7)
					.withTopP(1.0)
	...
	public void moonshotChatTransientError() {
		...
		ChatCompletion expectedChatCompletion = new ChatCompletion("id", "chat.completion", 789L, "model",
				List.of(choice), new BaichuanApi.Usage(10, 10, 10), null);
