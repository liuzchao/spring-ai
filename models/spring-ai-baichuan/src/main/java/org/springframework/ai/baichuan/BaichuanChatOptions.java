...
public class BaichuanChatOptions implements FunctionCallingOptions, ChatOptions {
	...
	private @JsonProperty("tools") List<BaichuanApi.FunctionTool> tools;
	 ...
	 * {@link BaichuanApi.ChatCompletionRequest.ToolChoiceBuilder} to create a tool choice
	 * object.
	 */
	private @JsonProperty("tool_choice") String toolChoice;

	/**
	 * Baichaun Tool Function Callbacks to register with the ChatModel. For Prompt Options
	...
	/**
	 * A unique identifier representing your end-user, which can help Baichaun to monitor
	 * and detect abuse.
	 */
	...
	@Override
	public BaichuanChatOptions copy() {
	...
	public boolean equals(Object obj) {
		...
		BaichuanChatOptions other = (BaichuanChatOptions) obj;
		if (this.model == null) {
			if (other.model != null) {
				return false;
			}
	...
	public static class Builder {
		...
		protected BaichuanChatOptions options;

		public Builder() {
			this.options = new BaichuanChatOptions();
		}

		public Builder(BaichuanChatOptions options) {
		...
		public Builder withTools(List<BaichuanApi.FunctionTool> tools) {
		...
		public BaichuanChatOptions build() {
			return this.options;
		}
